...
font = pygame.font.Font("Baskic8.otf", 30)
...
def main_menu():
    ...
    while True:
        ...
        screen.blit(bg, (0, 0))
        draw_text('You lost...', font, (255, 255, 255), screen, 100, 200)
        draw_text('Press space to try again!', font, (255, 255, 255), screen, 100, 250)
